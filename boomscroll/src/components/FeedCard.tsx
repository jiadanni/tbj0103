...
export default function FeedCard({ card, mode, revealed }: FeedCardProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-between bg-zinc-950 px-6 pt-[max(7.5rem,calc(env(safe-area-inset-top)+5rem))] pb-[max(4rem,calc(env(safe-area-inset-bottom)+2.5rem))] text-center select-none overflow-hidden touch-none">
