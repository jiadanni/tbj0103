...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(authenticated_handler(tauri::generate_handler![
            ...
            commands::background_jobs::get_inference_job_settings,
            commands::background_jobs::get_inference_job_statuses,
            commands::background_jobs::set_inference_job_setting,
            commands::background_jobs::set_current_workspace_id,
            commands::background_jobs::list_active_background_jobs,
            commands::background_jobs::pause_background_scheduler,
            commands::background_jobs::resume_background_scheduler,
            commands::background_jobs::get_background_scheduler_pause_status,
            ...
            commands::chat::list_session_branches,
            commands::chat::search_chat_sessions,
            commands::chat::list_history_sessions,
            commands::chat::get_chat_session,
            commands::chat::get_chat_session_by_id,
            ...
            commands::chat::retry_chat_file_sync,
            ...
            commands::knowledge_graph::capture_roadmap_snapshot,
            ...
            commands::feed::load_feed_deck,
            commands::feed::set_card_suspended,
            commands::feed::restore_all_suspended,
            commands::feed::set_card_difficulty,
            commands::feed::set_workspace_difficulty_preset,
            ...
            commands::settings::get_inference_settings,
            ...
            commands::memory::list_memory_summary_snapshots,
            commands::memory::restore_memory_summary_snapshot,
            // MCP commands
            ...
            commands::git_sync::set_git_sync_device_label,
            commands::git_sync::set_git_sync_main_role,
            commands::git_sync::list_git_sync_devices,
            commands::git_sync::list_pending_promotions,
            commands::git_sync::promote_chat_to_main,
            commands::git_sync::promote_all_diverged_chats,
            // Quick search
