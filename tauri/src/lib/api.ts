...
export const api = {
  ...
  workspace: {
    ...
    update: (id: string, name: string, description?: string, promptInstructions?: string, surveyData?: string, excludeFromAiAnalysis?: boolean, aboutYou?: string, ignoreNameInAiContext?: boolean) => invoke<void>("update_workspace", { req: { id, name, description, prompt_instructions: promptInstructions, survey_data: surveyData, exclude_from_ai_analysis: excludeFromAiAnalysis, about_you: aboutYou, ignore_name_in_ai_context: ignoreNameInAiContext } }),
