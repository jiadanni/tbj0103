...
import { Palette, Bot, ShieldCheck, HardDrive, Trash2, Plus, LayoutGrid, Network, Globe, RefreshCw, GitBranch, Settings as SettingsIcon, MessageSquare, FileText, FolderInput, ScrollText, Eye, EyeOff, Info, Brain, ChevronDown, Lock, GraduationCap, Search, UserCircle, SlidersHorizontal, X } from "lucide-react";
