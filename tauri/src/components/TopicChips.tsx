    ...
    <div className="flex flex-row overflow-x-auto gap-2.5 px-1 py-1" style={{ scrollbarWidth: "none" }}>
      {displayTags.map((t) => (
        <button
          ...
          className="inline-flex items-center rounded-full border border-transparent bg-[rgba(255,255,255,0.06)] px-3.5 py-1.5 text-[11px] font-semibold whitespace-nowrap tracking-[0.01em] text-[rgba(255,255,255,0.65)] transition-all duration-150 hover:bg-[rgba(255,255,255,0.10)] hover:text-white"
