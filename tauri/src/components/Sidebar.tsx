...
export default function Sidebar({
  ...
  return (
    <div className={`flex h-full flex-col bg-[var(--bg-base)] border-r border-[var(--surface-border)] shrink-0 transition-[width] duration-200 ${labelsVisible ? "w-44" : "w-14 items-center"}`}>
      ...
      <div className="flex-1 overflow-y-auto py-2.5 w-full">
        {labelsVisible ? (
      ...
      <div className={`relative border-t border-[var(--surface-border)] ${!labelsVisible ? "p-2 flex flex-col items-center" : "p-2"}`}>
        ...
        {presentation === "sidebar" && (
          <button
            ...
            className={
              !labelsVisible
                ? "mb-1 flex h-10 w-10 items-center justify-center rounded-lg text-[var(--text-secondary)] transition-colors hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)]"
                : "flex w-full items-center gap-2 h-7 px-2.5 rounded-lg text-[12.5px] text-[var(--text-secondary)] transition-colors hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)]"
            }
          >
            {labelsVisible ? <ChevronLeft size={14} strokeWidth={1.7} /> : <ChevronRight size={16} strokeWidth={1.5} />}
            {labelsVisible && <span className="flex-1 text-left">Collapse</span>}
          </button>
        )}

        {showPreferencesButton && (
          <div className={!labelsVisible ? "mb-2" : "flex items-center gap-1"}>
            <button
              onClick={() => {
                setTooltip(null);
                setPopoverOpen(false);
              ...
              className={
                !labelsVisible
                  ...
                  : `flex flex-1 items-center gap-2 h-7 rounded-lg px-2.5 text-[12.5px] transition-colors ${
                      isPreferencesActive
                        ? activeNavClassName
                        : inactiveNavClassName
                    }`
        ...
        <button
          ...
          className={
            !labelsVisible
              ...
              : `mt-1.5 w-full min-w-0 flex items-center gap-2 h-[30px] px-2 rounded-lg border border-[var(--surface-border)] text-[12.5px] transition-colors ${
                  popoverOpen
                    ? "bg-[var(--bg-hover)] text-[var(--text-primary)]"
        ...
        >
          <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-[var(--accent-color)] text-white text-[11px] font-mono font-bold">
            A
          </div>
          {labelsVisible && (
            <>
              <span className="min-w-0 flex-1 truncate text-left font-medium text-[var(--text-primary)]">Aetherium</span>
              <ChevronUp size={13} strokeWidth={1.7} className={`shrink-0 transition-transform ${popoverOpen ? "" : "rotate-180"}`} />
            </>
          )}
        </button>
